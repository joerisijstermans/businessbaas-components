(function () {
  if (customElements.get('bb1-gratis-training-bedankt')) return;
  ...
  const C = ['bb-gratis-training-bedankt'];
  ...
  class BB1GratisBedankt extends HTMLElement {
  ...
  customElements.define('bb1-gratis-training-bedankt', BB1GratisBedankt);
})();
