(function () {
  if (customElements.get('bb1-prijzen')) return;
  ...
  const C = ['bb-pricing-header','bb-pricing-main','bb-pricing-faq'];
  ...
  class BB1Prijzen extends HTMLElement {
  ...
  customElements.define('bb1-prijzen', BB1Prijzen);
})();
