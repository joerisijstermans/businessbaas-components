(function () {
  if (customElements.get('bb1-gratis-training-bekijken-boven')) return;
  ...
  const C = ['bb-funnel-top','bb-funnel-bridge','bb-funnel-notification'];
  ...
  class BB1GratisTrainingBekijkenBoven extends HTMLElement {
  ...
  customElements.define('bb1-gratis-training-bekijken-boven', BB1GratisTrainingBekijkenBoven);
})();
