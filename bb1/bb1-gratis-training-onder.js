(function () {
  if (customElements.get('bb1-gratis-training-onder')) return;
  ...
  const C = ['bb-landing-pricing','bb-landing-faq','bb-landing-cta','bb-landing-notification'];
  ...
  class BB1GratisTrainingOnder extends HTMLElement {
  ...
  customElements.define('bb1-gratis-training-onder', BB1GratisTrainingOnder);
})();
