(function () {
  if (customElements.get('bb1-gratis-training-aanvragen-boven')) return;
  ...
  class BB1GratisAanvragenBoven extends HTMLElement {
  ...
  customElements.define('bb1-gratis-training-aanvragen-boven', BB1GratisAanvragenBoven);
})();
