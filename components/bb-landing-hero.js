        ...
        <section class="hero">
          <div class="hero-inner">
            ...
            <div class="hero-cta-wrap ob">
              <a href="https://www.businessbaas.com/gratis-training" class="btn-primary" onclick="event.preventDefault();window.openTrainingLightbox&&window.openTrainingLightbox();">
