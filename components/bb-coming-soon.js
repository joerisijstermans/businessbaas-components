      ...
      s.innerHTML = `
        ...
        <style>
          *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
          ...
          .page{background:linear-gradient(150deg,#0D2240 0%,#142c54 60%,#0f2845 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:120px 24px;position:relative;overflow:hidden}
