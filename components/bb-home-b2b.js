      ...
      this.shadowRoot.innerHTML = `
        ...
        <style>
          ...
          *{box-sizing:border-box;margin:0;padding:0;}
          section{background:var(--navy);padding:80px 24px;font-family:var(--font);position:relative;overflow:hidden;}
          ...
          .lbl{display:inline-flex;align-items:center;gap:10px;font-size:11.5px;font-weight:700;color:#FF8C42;text-transform:uppercase;letter-spacing:0.10em;margin-bottom:16px;}
          ...
          .left h2 em{font-style:normal;color:#FF8C42;}
          ...
          .skn{font-size:38px;font-weight:900;color:#FF8C42;letter-spacing:-0.04em;line-height:1;}
          ...
          <div class="inner">
            <div class="layout">
              <div class="left ob">
                ...
                <div class="ctas">
                  <a href="https://www.businessbaas.com/voor-partners" class="bm">Word partner <svg width="15" height="15" viewBox="0 0 15 15" fill="none"><path d="M3 7.5H12M12 7.5L8.5 4M12 7.5L8.5 11" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
                  <a href="https://www.businessbaas.com/voor-partners" class="bg">Gratis demo aanvragen</a>
                </div>
              </div>
              <div class="right">
                <div class="sc ob">
