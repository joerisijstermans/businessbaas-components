  ...
  class BBHomeProof extends HTMLElement {
    ...
    connectedCallback() {
      this._t = [
        ...
        { name:'Stephan Janssen', company:'Stephan Media', quote:'Via Businessbaas heb ik een goed framework gekregen om mijn onderneming een goede start te geven. De community is iets waar ik veel extra waarde uit haal door met lokale ondernemers te kunnen sparren over problemen waar we tegenaan lopen.', result:'Framework ̩n actieve community', av:`${CDN}/stephan-prof.webp`, highlight:'veel extra waarde' },
        { name:'Shauna Mols', company:'Mols marketing', quote:'Dankzij BusinessBaas heb ik niet alleen mijn bedrijf vormgegeven, maar ook mezelf opnieuw leren kennen als ondernemer. D̩ investering voor elke starter die m̩̩r wil dan alleen een goed businessplan.', result:'Stevige basis voor bedrijf ̩n zichzelf', av:`${CDN}/shauna-prof.webp`, highlight:'D̩ investering voor elke starter' },
        { name:'Jorn Gijzen', company:'Talent Rocketeers', quote:'Nova voelt als een ̩cht persoon om mee te sparren: ze helpt mijn plannen te structureren en geeft precies de juiste inspiratie wanneer ik vastloop. Bovendien is de prijs-kwaliteitverhouding top: professionele tools, coaching ̩n een actieve community.', result:'Stap voor stap opgestart in eigen tempo', av:`${CDN}/jorn-prof.webp`, highlight:'prijs-kwaliteitverhouding top' },
        ...
        { name:'Inge H̦per', company:'Kommeshier', quote:'Het baken bij het starten van een bedrijf! Een duidelijke weg, stap voor stap, en helder advies als het even niet zo gaat als je graag zou willen.', result:'Duidelijke weg, stap voor stap', av:`${CDN}/inge-prof.webp`, highlight:'stap voor stap' },
      ];
