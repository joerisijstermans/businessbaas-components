(function () {
  ...
  class BBHomeProof extends HTMLElement {
    ...
    connectedCallback() {
      this._t = [
        { name:'Juurd Beijer', company:'Juurd Beijer Fotografie', quote:'Het heeft mij heel erg uit de comfort zone getrokken om daadwerkelijk nieuwe stappen te zetten. Tijdens het live event heb ik nieuwe mensen ontmoet, contacten gelegd en zelfs een nieuwe klant ontmoet! Kan ik BusinessBaas alleen maar aanraden.', result:'Nieuwe klant via live event', av:`${CDN}/juurd-prof.webp`, highlight:'een nieuwe klant ontmoet' },
        { name:'Sandra Klein', company:'Sandra-Coacht', quote:'Wat een energie en inspiratie op het Businessbaas Live Event! Ik werd getriggerd om in mijn pitch mijn unieke \'ik\' nog duidelijker te laten zien. Grote complimenten aan Joeri en het hele team, ga zo door!', result:'Finalist Limburg Award 2025', av:`${CDN}/sandra-prof.webp`, highlight:"mijn unieke 'ik' nog duidelijker" },
        { name:'Joyce Bekkers', company:'Kindercoach The Joy', quote:'Het brengt mij meer zelfvertrouwen en zekerheid in mijn startende bedrijf. Met focus en stapsgewijs door de trainingen gaan krijg je meer gevoel dat je bedrijf tot leven komt. Geweldig en een echte aanrader!', result:'Meer zelfvertrouwen als ondernemer', av:`${CDN}/joyce-prof.webp`, highlight:'meer zelfvertrouwen en zekerheid' },
        { name:'Stan Vreuls', company:'21x', quote:'Van het uitwerken van je idee tot het binnenhalen van je eerste klanten, je staat er niet alleen voor. Echt een stevige basis om mee te starten!', result:'Stevige basis voor zijn nieuwe bedrijf', av:`${CDN}/stan-prof.webp`, highlight:'eerste klanten' },
        { name:'Stephan Janssen', company:'Stephan Media', quote:'Via Businessbaas heb ik een goed framework gekregen om mijn onderneming een goede start te geven. De community is iets waar ik veel extra waarde uit haal door met lokale ondernemers te kunnen sparren over problemen waar we tegenaan lopen.', result:'Framework én actieve community', av:`${CDN}/stephan-prof.webp`, highlight:'veel extra waarde' },
        { name:'Shauna Mols', company:'Mols marketing', quote:'Dankzij BusinessBaas heb ik niet alleen mijn bedrijf vormgegeven, maar ook mezelf opnieuw leren kennen als ondernemer. Dé investering voor elke starter die méér wil dan alleen een goed businessplan.', result:'Stevige basis voor bedrijf én zichzelf', av:`${CDN}/shauna-prof.webp`, highlight:'Dé investering voor elke starter' },
        { name:'Jorn Gijzen', company:'Talent Rocketeers', quote:'Nova voelt als een écht persoon om mee te sparren: ze helpt mijn plannen te structureren en geeft precies de juiste inspiratie wanneer ik vastloop. Bovendien is de prijs-kwaliteitverhouding top: professionele tools, coaching én een actieve community.', result:'Stap voor stap opgestart in eigen tempo', av:`${CDN}/jorn-prof.webp`, highlight:'prijs-kwaliteitverhouding top' },
        { name:'Katharina März', company:'Katharinazorg', quote:'Stap voor stap ga je aan het werk, niets wordt overgeslagen. Joeri kijkt persoonlijk met je mee en je krijgt advies en een fijne uitleg hoe je dingen kan aanpakken. Echt een aanrader voor persoonlijke ontwikkeling en groei!', result:'Persoonlijk advies op maat', av:`${CDN}/katharina-prof.webp`, highlight:'Joeri kijkt persoonlijk met je mee' },
        { name:'Gijs Kohlen', company:'CitralStudios', quote:'Dankzij BusinessBaas heb ik mijn ondernemersmindset echt kunnen aanscherpen. Het heeft me geholpen om niet alleen naar de groei van mijn bedrijf te kijken, maar ook naar mijn eigen ontwikkeling als ondernemer. Een waardevolle investering die je echt in beweging brengt.', result:'Ondernemersmindset aangescherpt', av:`${CDN}/gijs-prof.webp`, highlight:'ondernemersmindset echt kunnen aanscherpen' },
        { name:'Loes Kluter', company:'Kluter Vastgoedpresentatie', quote:'Die training heeft echt het verschil gemaakt voor mijn bedrijf! Dankzij de praktische en heldere aanpak heb ik mijn niche scherp voor ogen én weet ik hoe ik ze gericht kan aanspreken. Absoluut een aanrader!', result:'Niche scherp en gericht aanpakken', av:`${CDN}/loes-prof.webp`, highlight:'het verschil gemaakt voor mijn bedrijf' },
        { name:'Inge Höper', company:'Kommeshier', quote:'Het baken bij het starten van een bedrijf! Een duidelijke weg, stap voor stap, en helder advies als het even niet zo gaat als je graag zou willen.', result:'Duidelijke weg, stap voor stap', av:`${CDN}/inge-prof.webp`, highlight:'stap voor stap' },
      ];
        ...
        <section>
          <div class="inner">
            ...
            <div class="cs ob">
              ...
              <a href="https://www.businessbaas.com/gratis-training-aanvragen" class="sb" target="_top" data-lightbox>Start jouw gratis training <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M3 8H13M13 8L9 4M13 8L9 12" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
            </div>
          </div>
        </section>`;
    }
