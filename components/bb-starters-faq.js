  ...
  class BBStartersFaq extends HTMLElement {
    ...
    render() {
      const faqs = [
        ...
        { q:'Hoeveel tijd heb ik per week nodig?', a:'Gemiddeld 3–5 uur per week. Je werkt volledig in jouw eigen tempo. De trainingen zijn kort en gericht op concrete actie, geen marathonsessies.' },
