(function () {
  if (customElements.get('bb-invite-bevestigd')) return;
  class BBInviteBevestigd extends HTMLElement {
    connectedCallback() {
      ...
      s.innerHTML = `
        ...
        <style>
          *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
          ...
          .spam-note{background:rgba(251,188,4,.08);border:1px solid rgba(251,188,4,.2);border-radius:12px;padding:14px 18px;font-size:13px;color:rgba(251,188,4,.85);display:flex;align-items:center;gap:10px;margin-bottom:32px;text-align:left}
          ...
          <div class="inner">
            <div class="check">
              <svg viewBox="0 0 36 36" fill="none">
                <path d="M8 18L15 25L28 11" stroke="#22C55E" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </div>
            <div class="label">Uitnodiging geaccepteerd</div>
            <h1>Deelname bevestigd!<br>Check je <em>inbox</em>.</h1>
            <p class="sub">Welkom bij BusinessBaas. Je ontvangt zo twee e-mails. <strong>Het kan een paar minuten duren voordat ze aankomen.</strong></p>
            <div class="cards">
              <div class="card">
                <div class="cicon">🔑</div>
                <div class="cinfo">
              ...
              <div class="card">
                ...
                <div class="cinfo">
                  ...
                  <p>Je ontvangt ook een onboardingse-mail met uitleg over het platform en jouw eerste stappen. Staat er niks in je inbox? Check dan je spammap.</p>
                </div>
              </div>
              <div class="card">
                <div class="cicon">🚀</div>
  ...
  customElements.define('bb-invite-bevestigd', BBInviteBevestigd);
})();
