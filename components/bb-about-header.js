(function () {
  if (customElements.get('bb-about-header')) return;
  class BBAboutHeader extends HTMLElement {
    connectedCallback() {
      ...
      s.innerHTML = `
        ...
        <style>
          *{box-sizing:border-box;margin:0;padding:0}
          ...
          .lbl{display:inline-flex;align-items:center;gap:10px;font-size:11px;font-weight:700;color:rgba(232,93,4,.9);text-transform:uppercase;letter-spacing:.09em;margin-bottom:22px}
        ...
        <div class="ph">
          <div class="lbl">Ons verhaal</div>
          <h1>Over Ons</h1>
          <p>Wie we zijn en waarom we BusinessBaas bouwen</p>
        </div>`;
    }
  }
  customElements.define('bb-about-header', BBAboutHeader);
})();
