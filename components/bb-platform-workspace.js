      ...
      s.innerHTML = `
        ...
        <style>
          *{box-sizing:border-box;margin:0;padding:0}
          ...
          .lbl{display:inline-flex;align-items:center;gap:10px;font-size:.8rem;font-weight:700;color:#E85D04;letter-spacing:.12em;text-transform:uppercase;margin-bottom:14px}
