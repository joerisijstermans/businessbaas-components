      ...
      s.innerHTML = `
        ...
        <section class="faq">
          <div class="faq-inner">
            ...
            <div class="faq-item ob"><button class="faq-q">Hoeveel tijd kost het per week?<span class="faq-icon">+</span></button><div class="faq-a"><p>Wij adviseren tussen de 2 en 4 uur per week, maar jij bepaalt dat helemaal zelf. Je werkt op jouw eigen tempo: wanneer jij tijd hebt, wanneer het jou uitkomt. De trainingen zijn kort en gericht op concrete actie, geen marathonsessies.</p></div></div>
