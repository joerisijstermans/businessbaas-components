      ...
      s.innerHTML = `
        ...
        <style>
          *{box-sizing:border-box;margin:0;padding:0}
          ...
          .btn-w{background:#fff;color:#E85D04;padding:16px 36px;border-radius:50px;font-size:1rem;font-weight:700;text-decoration:none;transition:all .2s;display:inline-block;font-family:'Inter',sans-serif}
          .btn-w:hover{background:rgba(255,255,255,.9);transform:translateY(-2px)}
          .btn-g{border:2px solid rgba(255,255,255,.5);color:#fff;padding:16px 36px;border-radius:50px;font-size:1rem;font-weight:600;text-decoration:none;transition:all .2s;display:inline-block;font-family:'Inter',sans-serif}
        ...
        <section>
          <div class="inner">
            ...
            <div class="btns ob">
              <a class="btn-w" href="/voor-starters">Start gratis training</a>
              <a class="btn-g" href="/contact">Stel een vraag</a>
            </div>
          </div>
        </section>`;
